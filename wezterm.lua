...
local function get_process(tab)
	local process_icons = {
		...
		["python"] = {
			...
			{ Text = wezterm.nerdfonts.mdi_language_python_text },
		},
		["zsh"] = {
			{ Foreground = { Color = colors.subtext1 } },
	...
	local process_name = string.gsub(tab.active_pane.foreground_process_name, "(.*[/\\])(.*)(.exe)", "%2") -- remove (.exe) for linux and create a query checking OS
